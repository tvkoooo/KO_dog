...
//////////////////////////////////////////////////////////////////////////
void mm_business_relation_tcp_hd_c_business_relation_rename_friend_remark_rq(void* obj, void* u, struct mm_packet* rq_pack)
{
	c_business_relation::rename_friend_remark_rq rq_msg;
	...
	do 
	{
		...
		const std::string& user_friend_remark = rq_msg.user_friend_remark();
		//////////////////////////////////////////////////////////////////////////
		//rs更新部分数据
		rs_msg.set_user_friend_id(user_friend_id);
		rs_msg.set_user_friend_remark(user_friend_remark);
		//////////////////////////////////////////////////////////////////////////
		//操作数据库（修改好友备注名  p_user_relation_change_remark）
		struct mm_db_mysql* db_mysql = mm_db_mysql_section_thread_instance(&impl->db_sql_section);
		{

			mm::p_user_relation_change_remark query;
			query.myself_id = user_myself_id;
			query.friend_id = user_friend_id;
			query.friend_remark = user_friend_remark;
	...
	// rs
	mm_tcp_o_lock(tcp);
	mm_protobuf_cxx_n_tcp_append_rs(mailbox, tcp, c_business_relation::rename_friend_remark_rs_msg_id, &rs_msg, rq_pack, &rs_pack);
