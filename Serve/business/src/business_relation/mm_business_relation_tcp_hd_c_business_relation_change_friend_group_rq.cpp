...
//////////////////////////////////////////////////////////////////////////
void mm_business_relation_tcp_hd_c_business_relation_change_friend_group_rq(void* obj, void* u, struct mm_packet* rq_pack)
{
	c_business_relation::change_friend_group_rq rq_msg;
	...
	error_info->set_desc("");
	rs_msg.set_user_friend_id(0);
	rs_msg.set_user_friend_group_id_old(0);
	rs_msg.set_user_friend_group_id_new(0);
	////////////////////////////////
	...
	do 
	{
		...
		mm_uint64_t user_friend_id = rq_msg.user_friend_id();
		mm_uint64_t user_friend_group_id_old = rq_msg.user_friend_group_id_old();
		mm_uint64_t user_friend_group_id_new = rq_msg.user_friend_group_id_new();
		//////////////////////////////////////////////////////////////////////////
		//rs更新部分数据
		rs_msg.set_user_friend_id(user_friend_id);
		rs_msg.set_user_friend_group_id_old(user_friend_group_id_old);
		rs_msg.set_user_friend_group_id_new(user_friend_group_id_new);
		//////////////////////////////////////////////////////////////////////////
		//操作数据库（  p_user_relation_delete_group）
		struct mm_db_mysql* db_mysql = mm_db_mysql_section_thread_instance(&impl->db_sql_section);
		{

			mm::p_user_relation_change_group query;
			query.myself_id = user_myself_id;
			query.friend_id = user_friend_id;
			query.friend_group_id_old = user_friend_group_id_old;
			query.friend_group_id_new = user_friend_group_id_new;
	...
	// rs
	mm_tcp_o_lock(tcp);
	mm_protobuf_cxx_n_tcp_append_rs(mailbox, tcp, c_business_relation::change_friend_group_rs_msg_id, &rs_msg, rq_pack, &rs_pack);
