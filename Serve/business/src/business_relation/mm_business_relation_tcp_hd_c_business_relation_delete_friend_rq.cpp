...
//////////////////////////////////////////////////////////////////////////
void mm_business_relation_tcp_hd_c_business_relation_delete_friend_rq(void* obj, void* u, struct mm_packet* rq_pack)
{
	c_business_relation::delete_friend_rq rq_msg;
...
//	struct mm_business_nt_message_sql* nt_message_sql= &impl->nt_message_sql;
	...
	do 
	{
		...
		mm_uint64_t user_delete_id = rq_msg.user_delete_id();
		rs_msg.set_user_delete_id(user_delete_id);
		//////////////////////////////////////////////////////////////////////////
		//拼装nt包
		nt_msg.set_apply_user_id(user_myself_id);
		//////////////////////////////////////////////////////////////////////////
		//操作数据库（删除好友--双方都删除好友关系）
		struct mm_db_mysql* db_mysql = mm_db_mysql_section_thread_instance(&impl->db_sql_section);
		{
			//删除申请人myself_id 的好友关系user_delete_id;
			{
				mm::p_user_relation_delete_friend query;
				query.myself_id = user_myself_id;
				query.friend_id = user_delete_id;
			...
			//删除申请人对象 user_delete_id 的好友关系myself_id;
			{
				mm::p_user_relation_delete_friend query;
				query.myself_id = user_delete_id;
		...
		//	user_myself_id, user_delete_id, c_business_relation::delete_friend_nt_msg_id, &nt_msg,
		//	&nt_pack);
		//////////////////////////////////////////////////////////////////////////
		//对nt包进行 cback 回推发送
		struct mm_packet_head packet_head;

		packet_head.mid = c_business_relation::delete_friend_nt_msg_id;
		packet_head.pid = 0;
		packet_head.sid = 0;
		packet_head.uid = user_delete_id;
	...
	// rs
	mm_tcp_o_lock(tcp);
	mm_protobuf_cxx_n_tcp_append_rs(mailbox, tcp, c_business_relation::delete_friend_rs_msg_id, &rs_msg, rq_pack, &rs_pack);
