...
void mm_business_relation_runtime_init(struct mm_business_relation_runtime* p)
{
...
void mm_business_relation_runtime_destroy(struct mm_business_relation_runtime* p)
{
...
//////////////////////////////////////////////////////////////////////////
void mm_business_relation_runtime_start(struct mm_business_relation_runtime* p)
{
	mm_zkwp_path_start(&p->zkwp_path);
}
void mm_business_relation_runtime_interrupt(struct mm_business_relation_runtime* p)
{
	mm_zkwp_path_interrupt(&p->zkwp_path);
}
void mm_business_relation_runtime_shutdown(struct mm_business_relation_runtime* p)
{
	mm_zkwp_path_shutdown(&p->zkwp_path);
}
void mm_business_relation_runtime_join(struct mm_business_relation_runtime* p)
{
	mm_zkwp_path_join(&p->zkwp_path);
}
//////////////////////////////////////////////////////////////////////////
void mm_business_relation_runtime_assign_parameters(struct mm_business_relation_runtime* p,mm_uint32_t unique_id, mm_uint32_t shard, mm_uint32_t depth)
{
...
void mm_business_relation_runtime_assign_launch_info(struct mm_business_relation_runtime* p,struct mm_business_relation_launch* launch_info)
{
	p->launch_info = launch_info;
}
void mm_business_relation_runtime_assign_internal_mailbox(struct mm_business_relation_runtime* p,struct mm_mailbox* internal_mailbox)
{
	p->internal_mailbox = internal_mailbox;
}
void mm_business_relation_runtime_assign_external_mailbox(struct mm_business_relation_runtime* p,struct mm_mailbox* external_mailbox)
{
	p->external_mailbox = external_mailbox;
}
void mm_business_relation_runtime_assign_zkwb_path(struct mm_business_relation_runtime* p,const char* path)
{
	mm_zkwp_path_assign_path(&p->zkwp_path,path);
}
void mm_business_relation_runtime_assign_zkwb_host(struct mm_business_relation_runtime* p,const char* host)
{
	mm_zkwp_path_assign_host(&p->zkwp_path,host);
}
// update runtime value.
void mm_business_relation_runtime_update_runtime(struct mm_business_relation_runtime* p)
{
...
// commit db.
void mm_business_relation_runtime_commit_db(struct mm_business_relation_runtime* p)
{
	// common runtime.
}
// commit zk.
void mm_business_relation_runtime_commit_zk(struct mm_business_relation_runtime* p)
{
