...
//////////////////////////////////////////////////////////////////////////
void mm_business_relation_launch_init(struct mm_business_relation_launch* p)
{
	p->unique_id = 0;
...
void mm_business_relation_launch_destroy(struct mm_business_relation_launch* p)
{
	p->unique_id = 0;
...
//////////////////////////////////////////////////////////////////////////
void mm_business_relation_launch_printf_information(struct mm_business_relation_launch* p)
{
	...
	mm_logger_log_I(g_logger,"服务实例编名称     mm_business_relation_%d",p->unique_id);
	mm_logger_log_I(g_logger,"程序名             %s","mm_business_relation");
