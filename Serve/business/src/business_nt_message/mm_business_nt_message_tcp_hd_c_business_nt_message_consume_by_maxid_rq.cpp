...
//////////////////////////////////////////////////////////////////////////
void mm_business_nt_message_tcp_hd_c_business_nt_message_consume_by_maxid_rq(void* obj, void* u, struct mm_packet* rq_pack)
{
	c_business_nt_message::nt_message_consume_by_maxid_rq rq_msg;
	c_business_nt_message::nt_message_consume_by_maxid_rs rs_msg;
	...
	do 
	{
		...
		mm_uint64_t note_maxid = rq_msg.note_maxid();
		//////////////////////////////////////////////////////////////////////////
		struct mm_db_mysql* db_mysql = mm_db_mysql_section_thread_instance(&impl->db_sql_section);
		{
			mm::p_nt_message_consume_by_max_note_id query;
			query.to_user_id = user_id;
			query.note_id = note_maxid;
	...
	// rs
	mm_tcp_lock(tcp);
	mm_protobuf_cxx_n_tcp_append_rs(mailbox, tcp, c_business_nt_message::nt_message_consume_by_maxid_rs_msg_id, &rs_msg, rq_pack, &rs_pack);
