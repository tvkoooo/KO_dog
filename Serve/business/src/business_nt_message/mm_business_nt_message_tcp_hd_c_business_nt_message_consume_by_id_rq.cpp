...
//////////////////////////////////////////////////////////////////////////
void mm_business_nt_message_tcp_hd_c_business_nt_message_consume_by_id_rq(void* obj, void* u, struct mm_packet* rq_pack)
{
	c_business_nt_message::nt_message_consume_by_id_rq rq_msg;
	c_business_nt_message::nt_message_consume_by_id_rs rs_msg;
	...
	// rs
	mm_tcp_lock(tcp);
	mm_protobuf_cxx_n_tcp_append_rs(mailbox, tcp, c_business_nt_message::nt_message_consume_by_id_rs_msg_id, &rs_msg, rq_pack, &rs_pack);
