...
//////////////////////////////////////////////////////////////////////////
void mm_business_nt_message_launch_init(struct mm_business_nt_message_launch* p)
{
	p->unique_id = 0;
...
void mm_business_nt_message_launch_destroy(struct mm_business_nt_message_launch* p)
{
	p->unique_id = 0;
...
//////////////////////////////////////////////////////////////////////////
void mm_business_nt_message_launch_printf_information(struct mm_business_nt_message_launch* p)
{
	...
	mm_logger_log_I(g_logger,"服务实例编名称     mm_business_nt_message_%d",p->unique_id);
	mm_logger_log_I(g_logger,"程序名             %s","mm_business_nt_message");
