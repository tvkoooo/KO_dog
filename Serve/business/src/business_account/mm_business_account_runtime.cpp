...
void mm_business_account_runtime_assign_internal_mailbox(struct mm_business_account_runtime* p,struct mm_mailbox* internal_mailbox)
{
	p->internal_mailbox = internal_mailbox;
}
void mm_business_account_runtime_assign_external_mailbox(struct mm_business_account_runtime* p,struct mm_mailbox* external_mailbox)
{
...
// commit db.
void mm_business_account_runtime_commit_db(struct mm_business_account_runtime* p)
{
	// common runtime.
}
// commit zk.
