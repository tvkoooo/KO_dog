...
void mm_basic_frame_entry_init(struct mm_basic_frame_entry* p)
{
	...
	p->msec_update_dt = MM_SHUTTLE_ENTRY_MSEC_UPDATE_DT;
	p->msec_launch_db = MM_SHUTTLE_ENTRY_MSEC_LAUNCH_DB;
	p->msec_commit_db = MM_SHUTTLE_ENTRY_MSEC_COMMIT_DB;
	p->msec_commit_zk = MM_SHUTTLE_ENTRY_MSEC_COMMIT_ZK;
...
void mm_basic_frame_entry_start(struct mm_basic_frame_entry* p)
{
	...
	mm_headset_assign_callback(&p->external_headset,c_basic_frame_entry::knock_rq_msg_id  ,&hd_basic_frame_entry_c_basic_frame_entry_knock_rq);
	//////////////////////////////////////////////////////////////////////////
	mm_basic_frame_entry_runtime_assign_zkwb_path(&p->runtime_info,MM_SHUTTLE_ENTRY_ZK_EXPORT);
	//
	mm_loavger_holder_assign_zkrb_path(&p->loavger_holder,MM_SHUTTLE_ENTRY_ZK_IMPORT);
	//////////////////////////////////////////////////////////////////////////
	// start headset.
