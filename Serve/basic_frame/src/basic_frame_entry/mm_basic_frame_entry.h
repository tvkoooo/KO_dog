...
#define MM_BASIC_FRAME_ENTRY_MSEC_UPDATE_DT  5000
// launch milliseconds.default is 60 second(60000 ms).
#define MM_BASIC_FRAME_ENTRY_MSEC_LAUNCH_DB 60000
// commit milliseconds.default is 10 second(10000 ms).
#define MM_BASIC_FRAME_ENTRY_MSEC_COMMIT_DB 10000
// commit milliseconds.default is 60 second(60000 ms).
#define MM_BASIC_FRAME_ENTRY_MSEC_COMMIT_ZK 60000

#define MM_BASIC_FRAME_ENTRY_ZK_IMPORT "/mm_lobby"
#define MM_BASIC_FRAME_ENTRY_ZK_EXPORT "/mm_entry"
...
struct mm_basic_frame_entry
{
	...
	mm_msec_t msec_update_dt;// launch milliseconds.default is MM_BASIC_FRAME_ENTRY_MSEC_UPDATE_DT.
	mm_msec_t msec_launch_db;// launch milliseconds.default is MM_BASIC_FRAME_ENTRY_MSEC_LAUNCH_DB.
	mm_msec_t msec_commit_db;// commit milliseconds.default is MM_BASIC_FRAME_ENTRY_MSEC_COMMIT_DB.
	mm_msec_t msec_commit_zk;// commit milliseconds.default is MM_BASIC_FRAME_ENTRY_MSEC_COMMIT_ZK.
};
//////////////////////////////////////////////////////////////////////////
