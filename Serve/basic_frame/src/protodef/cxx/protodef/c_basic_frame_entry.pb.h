...
#ifndef PROTOBUF_c_5fbasic_5fframe_5fentry_2eproto__INCLUDED
#define PROTOBUF_c_5fbasic_5fframe_5fentry_2eproto__INCLUDED
...
enum exchange_key_rq_msg {
  exchange_key_rq_msg_id = 33558544
};
...
enum exchange_key_rs_msg {
  exchange_key_rs_msg_id = 33558545
};
...
class knock_rq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:c_basic_frame_entry.knock_rq) */ {
 public:
  knock_rq();
  virtual ~knock_rq();
 ...
 private:
  ...
  friend struct protobuf_c_5fbasic_5fframe_5fentry_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class knock_rs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:c_basic_frame_entry.knock_rs) */ {
 public:
  knock_rs();
  virtual ~knock_rs();
  ...
  static const int kRemoteClientVersionFieldNumber = 3;
  ...
  static const int kRemoteSourceVersionFieldNumber = 4;
  ...
  static const int kRemoteServerVersionFieldNumber = 5;
...
class exchange_key_rq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:c_basic_frame_entry.exchange_key_rq) */ {
 public:
  exchange_key_rq();
...
class exchange_key_rs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:c_basic_frame_entry.exchange_key_rs) */ {
 public:
  exchange_key_rs();
...
template <> struct is_proto_enum< ::c_basic_frame_entry::knock_rq_msg> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::c_basic_frame_entry::knock_rq_msg>() {
  return ::c_basic_frame_entry::knock_rq_msg_descriptor();
}
template <> struct is_proto_enum< ::c_basic_frame_entry::knock_rs_msg> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::c_basic_frame_entry::knock_rs_msg>() {
  return ::c_basic_frame_entry::knock_rs_msg_descriptor();
}
template <> struct is_proto_enum< ::c_basic_frame_entry::exchange_key_rq_msg> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::c_basic_frame_entry::exchange_key_rq_msg>() {
  return ::c_basic_frame_entry::exchange_key_rq_msg_descriptor();
}
template <> struct is_proto_enum< ::c_basic_frame_entry::exchange_key_rs_msg> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::c_basic_frame_entry::exchange_key_rs_msg>() {
  return ::c_basic_frame_entry::exchange_key_rs_msg_descriptor();
}
template <> struct is_proto_enum< ::c_basic_frame_entry::msg> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::c_basic_frame_entry::msg>() {
  return ::c_basic_frame_entry::msg_descriptor();
}
...
#endif  // PROTOBUF_c_5fbasic_5fframe_5fentry_2eproto__INCLUDED
