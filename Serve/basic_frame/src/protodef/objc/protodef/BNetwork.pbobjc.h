 ...
 **/
@interface B_network_BNetworkRoot : GPBRootObject
@end

#pragma mark - B_network_address

typedef GPB_ENUM(B_network_address_FieldNumber) {
  B_network_address_FieldNumber_Host = 1,
  B_network_address_FieldNumber_Port = 2,
};

/**
 * 网络地址
 **/
@interface B_network_address : GPBMessage
