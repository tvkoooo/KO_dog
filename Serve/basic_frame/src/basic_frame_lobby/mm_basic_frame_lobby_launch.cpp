...
//////////////////////////////////////////////////////////////////////////
void mm_basic_frame_lobby_launch_init(struct mm_basic_frame_lobby_launch* p)
{
	p->unique_id = 0;
...
void mm_basic_frame_lobby_launch_destroy(struct mm_basic_frame_lobby_launch* p)
{
	p->unique_id = 0;
...
//////////////////////////////////////////////////////////////////////////
void mm_basic_frame_lobby_launch_printf_information(struct mm_basic_frame_lobby_launch* p)
{
	...
	mm_logger_log_I(g_logger,"服务实例编名称     mm_basic_frame_lobby_%d",p->unique_id);
	mm_logger_log_I(g_logger,"程序名             %s","mm_basic_frame_lobby");
