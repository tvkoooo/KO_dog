...
//////////////////////////////////////////////////////////////////////////
void hd_basic_frame_lobby_contact_handle( void* obj, void* u, struct mm_packet* rs_pack )
{
	////////////////////////////////
	...
	//
	hd_basic_frame_lobby_cback(impl,tcp,rs_pack);
}
void hd_basic_frame_lobby_contact_broken( void* obj )
{
	mm_contact_broken_default(obj);
}
void hd_basic_frame_lobby_contact_nready( void* obj )
{
	mm_contact_nready_default(obj);
}
void hd_basic_frame_lobby_contact_finish( void* obj )
{
