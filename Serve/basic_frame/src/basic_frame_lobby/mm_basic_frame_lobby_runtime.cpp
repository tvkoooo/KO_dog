...
//////////////////////////////////////////////////////////////////////////
void mm_basic_frame_lobby_runtime_init(struct mm_basic_frame_lobby_runtime* p)
{
...
void mm_basic_frame_lobby_runtime_destroy(struct mm_basic_frame_lobby_runtime* p)
{
...
//////////////////////////////////////////////////////////////////////////
void mm_basic_frame_lobby_runtime_start(struct mm_basic_frame_lobby_runtime* p)
{
	mm_zkwb_path_start(&p->zkwb_path);
}
void mm_basic_frame_lobby_runtime_interrupt(struct mm_basic_frame_lobby_runtime* p)
{
	mm_zkwb_path_interrupt(&p->zkwb_path);
}
void mm_basic_frame_lobby_runtime_shutdown(struct mm_basic_frame_lobby_runtime* p)
{
	mm_zkwb_path_shutdown(&p->zkwb_path);
}
void mm_basic_frame_lobby_runtime_join(struct mm_basic_frame_lobby_runtime* p)
{
	mm_zkwb_path_join(&p->zkwb_path);
}
//////////////////////////////////////////////////////////////////////////
void mm_basic_frame_lobby_runtime_assign_unique_id(struct mm_basic_frame_lobby_runtime* p,mm_uint32_t unique_id)
{
	p->runtime_state.unique_id = unique_id;
	mm_zkwb_path_assign_unique_id(&p->zkwb_path,unique_id);
}
void mm_basic_frame_lobby_runtime_assign_launch_info(struct mm_basic_frame_lobby_runtime* p,struct mm_basic_frame_lobby_launch* launch_info)
{
	p->launch_info = launch_info;
}
void mm_basic_frame_lobby_runtime_assign_internal_mailbox(struct mm_basic_frame_lobby_runtime* p,struct mm_mailbox* internal_mailbox)
{
	p->internal_mailbox = internal_mailbox;
}
void mm_basic_frame_lobby_runtime_assign_external_mailbox(struct mm_basic_frame_lobby_runtime* p,struct mm_mailbox* external_mailbox)
{
	p->external_mailbox = external_mailbox;
}
void mm_basic_frame_lobby_runtime_assign_zkwb_path(struct mm_basic_frame_lobby_runtime* p,const char* path)
{
	mm_zkwb_path_assign_path(&p->zkwb_path,path);
}
void mm_basic_frame_lobby_runtime_assign_zkwb_host(struct mm_basic_frame_lobby_runtime* p,const char* host)
{
	mm_zkwb_path_assign_host(&p->zkwb_path,host);
}
// update runtime value.
void mm_basic_frame_lobby_runtime_update_runtime(struct mm_basic_frame_lobby_runtime* p)
{
...
// commit db.
void mm_basic_frame_lobby_runtime_commit_db(struct mm_basic_frame_lobby_runtime* p)
{
	// common runtime.
}
// commit zk.
void mm_basic_frame_lobby_runtime_commit_zk(struct mm_basic_frame_lobby_runtime* p)
{
