...
_KNOCK_RQ_MSG = _descriptor.EnumDescriptor(
  name='msg',
  full_name='c_shuttle_entry.knock_rq.msg',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_KNOCK_RS_MSG = _descriptor.EnumDescriptor(
  name='msg',
  full_name='c_shuttle_entry.knock_rs.msg',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_KNOCK_RQ = _descriptor.Descriptor(
  name='knock_rq',
  full_name='c_shuttle_entry.knock_rq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='native_client_version', full_name='c_shuttle_entry.knock_rq.native_client_version', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='native_source_version', full_name='c_shuttle_entry.knock_rq.native_source_version', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='coord_info', full_name='c_shuttle_entry.knock_rq.coord_info', index=2,
...
_KNOCK_RS = _descriptor.Descriptor(
  name='knock_rs',
  full_name='c_shuttle_entry.knock_rs',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='error', full_name='c_shuttle_entry.knock_rs.error', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='addr', full_name='c_shuttle_entry.knock_rs.addr', index=1,
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\010protodefB\017c_shuttle_entryZ\030protodef/c_shuttle_entry\242\002\020C_shuttle_entry_\252\002\017c_shuttle_entry'))
