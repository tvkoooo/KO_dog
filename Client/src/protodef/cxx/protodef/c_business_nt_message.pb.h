...
class nt_message_all_unread_nt;
class nt_message_all_unread_ntDefaultTypeInternal;
extern nt_message_all_unread_ntDefaultTypeInternal _nt_message_all_unread_nt_default_instance_;
...
enum nt_message_all_unread_nt_msg {
  nt_message_all_unread_nt_msg_id = 33554437
};
bool nt_message_all_unread_nt_msg_IsValid(int value);
const nt_message_all_unread_nt_msg nt_message_all_unread_nt_msg_msg_MIN = nt_message_all_unread_nt_msg_id;
const nt_message_all_unread_nt_msg nt_message_all_unread_nt_msg_msg_MAX = nt_message_all_unread_nt_msg_id;
const int nt_message_all_unread_nt_msg_msg_ARRAYSIZE = nt_message_all_unread_nt_msg_msg_MAX + 1;

const ::google::protobuf::EnumDescriptor* nt_message_all_unread_nt_msg_descriptor();
inline const ::std::string& nt_message_all_unread_nt_msg_Name(nt_message_all_unread_nt_msg value) {
  return ::google::protobuf::internal::NameOfEnum(
    nt_message_all_unread_nt_msg_descriptor(), value);
}
inline bool nt_message_all_unread_nt_msg_Parse(
    const ::std::string& name, nt_message_all_unread_nt_msg* value) {
  return ::google::protobuf::internal::ParseNamedEnum<nt_message_all_unread_nt_msg>(
    nt_message_all_unread_nt_msg_descriptor(), name, value);
}
enum msg {
  min_id = 33554432,
  max_id = 33554687
...
class nt_message_all_unread_nt : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:c_business_nt_message.nt_message_all_unread_nt) */ {
 public:
  nt_message_all_unread_nt();
  virtual ~nt_message_all_unread_nt();

  nt_message_all_unread_nt(const nt_message_all_unread_nt& from);

  inline nt_message_all_unread_nt& operator=(const nt_message_all_unread_nt& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const nt_message_all_unread_nt& default_instance();

  static inline const nt_message_all_unread_nt* internal_default_instance() {
    return reinterpret_cast<const nt_message_all_unread_nt*>(
               &_nt_message_all_unread_nt_default_instance_);
  }
  static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
    8;

  void Swap(nt_message_all_unread_nt* other);

  // implements Message ----------------------------------------------

  inline nt_message_all_unread_nt* New() const PROTOBUF_FINAL { return New(NULL); }

  nt_message_all_unread_nt* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const nt_message_all_unread_nt& from);
  void MergeFrom(const nt_message_all_unread_nt& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(nt_message_all_unread_nt* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  typedef nt_message_all_unread_nt_msg msg;
  static const msg id =
    nt_message_all_unread_nt_msg_id;
  static inline bool msg_IsValid(int value) {
    return nt_message_all_unread_nt_msg_IsValid(value);
  }
  static const msg msg_MIN =
    nt_message_all_unread_nt_msg_msg_MIN;
  static const msg msg_MAX =
    nt_message_all_unread_nt_msg_msg_MAX;
  static const int msg_ARRAYSIZE =
    nt_message_all_unread_nt_msg_msg_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  msg_descriptor() {
    return nt_message_all_unread_nt_msg_descriptor();
  }
  static inline const ::std::string& msg_Name(msg value) {
    return nt_message_all_unread_nt_msg_Name(value);
  }
  static inline bool msg_Parse(const ::std::string& name,
      msg* value) {
    return nt_message_all_unread_nt_msg_Parse(name, value);
  }
...
// required uint64 user_id = 2;
inline bool nt_message_all_unread_nt::has_user_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void nt_message_all_unread_nt::set_has_user_id() {
  _has_bits_[0] |= 0x00000001u;
}
inline void nt_message_all_unread_nt::clear_has_user_id() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void nt_message_all_unread_nt::clear_user_id() {
  user_id_ = GOOGLE_ULONGLONG(0);
  clear_has_user_id();
}
inline ::google::protobuf::uint64 nt_message_all_unread_nt::user_id() const {
  // @@protoc_insertion_point(field_get:c_business_nt_message.nt_message_all_unread_nt.user_id)
  return user_id_;
}
inline void nt_message_all_unread_nt::set_user_id(::google::protobuf::uint64 value) {
  set_has_user_id();
  user_id_ = value;
...
template <> struct is_proto_enum< ::c_business_nt_message::nt_message_all_unread_nt_msg> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::c_business_nt_message::nt_message_all_unread_nt_msg>() {
  return ::c_business_nt_message::nt_message_all_unread_nt_msg_descriptor();
}
