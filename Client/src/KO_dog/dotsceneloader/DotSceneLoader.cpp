...
void DotSceneLoader::processTerrain(rapidxml::xml_node<>* XMLNode)
{
    ...
    Ogre::Vector3 lightdir((Ogre::Real)0, (Ogre::Real)-0.3, (Ogre::Real)0.75);
    lightdir.normalise();
    Ogre::Light* l = mSceneMgr->createLight("tstLight");
    l->setType(Ogre::Light::LT_DIRECTIONAL);
    l->setDirection(lightdir);
    l->setDiffuseColour(Ogre::ColourValue((Ogre::Real)1.0, (Ogre::Real)1.0, (Ogre::Real)1.0));
    l->setSpecularColour(Ogre::ColourValue((Ogre::Real)0.4, (Ogre::Real)0.4, (Ogre::Real)0.4));
    mSceneMgr->setAmbientLight(Ogre::ColourValue((Ogre::Real)0.6, (Ogre::Real)0.6, (Ogre::Real)0.6));
...
void DotSceneLoader::processCamera(rapidxml::xml_node<>* XMLNode, Ogre::SceneNode *pParent)
{
    ...
    Ogre::Real aspectRatio = getAttribReal(XMLNode, "aspectRatio", (Ogre::Real)1.3333);
...
{
    // Process attributes
    Ogre::Real expDensity = getAttribReal(XMLNode, "density", (Ogre::Real)0.001);
    Ogre::Real linearStart = getAttribReal(XMLNode, "start", (Ogre::Real)0.0);
    Ogre::Real linearEnd = getAttribReal(XMLNode, "end", (Ogre::Real)1.0);
