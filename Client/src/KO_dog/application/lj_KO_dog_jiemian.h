#ifndef __lj_KO_dog_jiemian_h__
#define __lj_KO_dog_jiemian_h__
...
namespace mm
{
	...
	public:
		lj_KO_dog_zhujiemian zhujiemian;

	public:
		lj_KO_dog_jiemian();
		virtual ~lj_KO_dog_jiemian();
