...
//{	
//
//	class KO_dog_mailbox_friend_group
//	{
//	public:
...
//
//	public:
//		KO_dog_mailbox_friend_group();
//		virtual ~KO_dog_mailbox_friend_group();
//
//	public:// set
//		void set_context(mm_flake_context* d_flake_context, mm_flake_surface* d_surface);
//		void set_layer(CEGUI::Window* l_layer);
//		void set_friend_talk(mm::data_relation_friendInfo* p_friend_talk);
//		void set_data_model(mm::data_relation_friendInfo* p_friend_talk);
